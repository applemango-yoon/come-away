...
{{
  ...
  "words": [
    {{
      ...
      "meaning": "표준 영어사전(옥스퍼드·메리엄웹스터 급)에서 ★흔한 뜻부터 차례로★ 한국어로 2~4개, 쉼표 구분. 이 본문에서 쓰인 뜻만 적지 말고, 그 뜻도 목록 안에 함께 넣어라. 의역·직역·성경식 풀이 금지. (예 so: '매우, 많이, 이 정도로, 이렇게')",
...
SCHEMA_VER = 24  # 분석 결과 형식 버전. 올리면 이전 캐시를 자동으로 무시하고 다시 분석함.
